...
static GtkItemFactoryEntry mainwindow_mainmenu[] = {
  { (gchar *)N_("/_Peer"),                NULL,         NULL, 0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Peer/Connect to _FICS"),NULL,GTK_SIGNAL_FUNC(peer_connect_fics),0,NULL },
  { (gchar *)N_("/Peer/ICS _Bookmarks"),  NULL, NULL, FA_ICSBOOKMARKS, (gchar *)"<Branch>" },
  { (gchar *)N_("/Peer/_Connect to Other Server..."),NULL,GTK_SIGNAL_FUNC(peer_connect_ask),0,NULL },
  { (gchar *)N_("/Peer/Direct connect with _Remote eboard..."),NULL,GTK_SIGNAL_FUNC(peer_connect_p2p),0,NULL },
  { (gchar *)N_("/Peer/sep4"),            NULL,           NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Peer/Play against _Engine"),NULL, NULL, 0,(gchar *)"<Branch>" },
  { (gchar *)N_("/Peer/Play against Engine/GNU Chess _4..."),NULL,GTK_SIGNAL_FUNC(peer_connect_gnuchess4),0, NULL },
  { (gchar *)N_("/Peer/Play against Engine/_Sjeng..."),NULL,GTK_SIGNAL_FUNC(peer_connect_sjeng), 0, NULL },
  { (gchar *)N_("/Peer/Play against Engine/Cr_afty..."),NULL,GTK_SIGNAL_FUNC(peer_connect_crafty), 0, NULL },
  { (gchar *)N_("/Peer/Play against Engine/sep1"),NULL,NULL,0,(gchar *)"<Separator>" },
  { (gchar *)N_("/Peer/Play against Engine/_Generic Engine..."),NULL,GTK_SIGNAL_FUNC(peer_connect_xboard), 0,NULL },
  { (gchar *)N_("/Peer/Engine B_ookmarks"), NULL, NULL, FA_ENGBOOKMARKS,(gchar *)"<Branch>" },
  { (gchar *)N_("/Peer/sep3"),            NULL,           NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Peer/_Empty Scratch Board"), NULL,  GTK_SIGNAL_FUNC(peer_scratch_empty), 0, NULL },
  { (gchar *)N_("/Peer/_Scratch Board with Initial Position"),NULL,  GTK_SIGNAL_FUNC(peer_scratch_initial), 0, NULL },
  { (gchar *)N_("/Peer/sep3"),            NULL,           NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Peer/_Disconnect"),     NULL,  GTK_SIGNAL_FUNC(peer_disconnect), 0, NULL },
  { (gchar *)N_("/Peer/sep2"),            NULL,           NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Peer/_Quit"),           NULL,  GTK_SIGNAL_FUNC(mainwindow_destroy), 0, NULL },
  { (gchar *)N_("/_Game"),                NULL,         NULL, 0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Game/_Resign"),         NULL,  GTK_SIGNAL_FUNC(game_resign), 0, NULL },
  { (gchar *)N_("/Game/_Offer Draw"),     NULL,  GTK_SIGNAL_FUNC(game_draw), 0, NULL },
  { (gchar *)N_("/Game/_Abort"),          NULL,  GTK_SIGNAL_FUNC(game_abort), 0, NULL },
  { (gchar *)N_("/Game/Ad_journ"),        NULL,  GTK_SIGNAL_FUNC(game_adjourn), 0, NULL },
  { (gchar *)N_("/Game/Retract _Move"),   NULL,  GTK_SIGNAL_FUNC(game_retract), 0, NULL },
  { (gchar *)N_("/_Settings"),            NULL,         NULL, 0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Settings/_Highlight Last Move"),NULL, NULL, FA_HIGHLIGHT, (gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/_Animate Moves"),NULL,       NULL, FA_ANIMATE,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/Pre_move"),      NULL,       NULL, FA_PREMOVE,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/Sho_w Coordinates"), NULL,   NULL, FA_COORDS,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/sep3"),          NULL,       NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Settings/_Beep on Opponent Moves"),NULL,NULL, FA_MOVEBEEP,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/_Enable Other Sounds"),NULL,NULL,    FA_SOUND,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/sep3"),          NULL,       NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Settings/_ICS Behavior"),   NULL,       NULL, 0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Settings/ICS Behavior/Popup Board Panes _Upon Creation"),NULL,NULL,FA_POPUP,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/ICS Behavior/Smart _Discard Observed Boards After Game Ends"),NULL,NULL,FA_SMART,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/sep3"),          NULL,       NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Settings/Enable Legality _Checking"),NULL,NULL,FA_LEGALITY,(gchar *)"<CheckItem>"},
  { (gchar *)N_("/Settings/sep3"),          NULL,       NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Settings/_Vectorized Pieces (Faster Rendering)"),NULL,NULL,FA_VECTOR,(gchar *)"<CheckItem>" },
  { (gchar *)N_("/Settings/Bitmapped Piece _Sets"),   NULL,       NULL, 0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Settings/Bitmapped Piece Sets/Load _Theme"), NULL,NULL, FA_LOADTHEME, (gchar *)"<Branch>" },
  { (gchar *)N_("/Settings/Bitmapped Piece Sets/Load _Pieces Only"),NULL,NULL,FA_LOADPIECES,(gchar *)"<Branch>"},
  { (gchar *)N_("/Settings/Bitmapped Piece Sets/Load _Squares Only"), NULL, NULL, FA_LOADSQUARES, (gchar *)"<Branch>" },
  { (gchar *)N_("/Settings/sep3"),          NULL,       NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Settings/_Preferences..."), NULL,  GTK_SIGNAL_FUNC(sett_prefs), 0, NULL },
  { (gchar *)N_("/_Windows"),              NULL,         NULL,0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Windows/_Games on Server..."),NULL,  GTK_SIGNAL_FUNC(windows_games), 0, NULL },
  { (gchar *)N_("/Windows/_Ads on Server..."),NULL,  GTK_SIGNAL_FUNC(windows_sough), 0, NULL },
  { (gchar *)N_("/Windows/sep1"), NULL, NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Windows/Games on _Client..."),NULL,  GTK_SIGNAL_FUNC(windows_stock), 0, NULL },
  { (gchar *)N_("/Windows/sep2"), NULL, NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Windows/_Run Script..."),  NULL,  GTK_SIGNAL_FUNC(windows_script), 0, NULL },
  { (gchar *)N_("/Windows/sep3"), NULL, NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Windows/_Detached Console"),  NULL,  GTK_SIGNAL_FUNC(windows_detached), 0, NULL },
  { (gchar *)N_("/Windows/sep3"), NULL, NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Windows/_Find Text (upwards)..."), NULL, GTK_SIGNAL_FUNC(windows_find), 0, NULL },
  { (gchar *)N_("/Windows/Find _Previous"), NULL, GTK_SIGNAL_FUNC(windows_findp), 0, NULL },
  { (gchar *)N_("/Windows/Save _Text Buffer..."), NULL, GTK_SIGNAL_FUNC(windows_savebuffer),0,NULL},
  { (gchar *)N_("/Windows/sep3"), NULL, NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Windows/Save Desktop _Geometry"), NULL, GTK_SIGNAL_FUNC(windows_savedesk), 0, NULL },
  { (gchar *)N_("/_Help"),              NULL,         NULL,0, (gchar *)"<Branch>" },
  { (gchar *)N_("/Help/_Getting Started"),NULL, GTK_SIGNAL_FUNC(help_starting), 0, NULL },
  { (gchar *)N_("/Help/_Keys"),NULL, GTK_SIGNAL_FUNC(help_keys), 0, NULL },
  { (gchar *)N_("/Help/_Debug Info"),NULL, GTK_SIGNAL_FUNC(help_debug), 0, NULL },
  { (gchar *)N_("/Help/sep4"),            NULL,           NULL, 0, (gchar *)"<Separator>" },
  { (gchar *)N_("/Help/_About eboard..."),NULL,  GTK_SIGNAL_FUNC(help_about), 0, NULL },
...
void MainWindow::setTitle(const char *msg) {
...
void MainWindow::openServer(const char *host,int port,Protocol *protocol,
			    const char *helper) {
...
void MainWindow::tryConnect(const char *host,int port,Protocol *protocol,
			    const char *helper)
{
...
void InputModeSelector::setPrefix(const char *s) {
  prefix=s;
