/* $Id: text.h,v 1.26 2010/06/29 18:04:37 bergo Exp $ */
...
class OutputPane {
 public:
  virtual ~OutputPane();
  virtual void append(const char *msg,int color,Importance imp=IM_NORMAL)=0;
  virtual void append(const char *msg,const char *msg2,int color,Importance imp=IM_NORMAL)=0;
...
class TextFilter {
 public:
  ...
  bool accept(const char *textline);
...
class Text : public NText,
 ...
 virtual ~Text();
  ...
  void append(const char *msg,int color,Importance imp=IM_NORMAL);
  void append(const char *msg,const char *msg2,int color,Importance imp=IM_NORMAL);
