/* $Id: position.h,v 1.32 2010/06/29 18:04:37 bergo Exp $ */
...
class Position {
 public:
  ...
  void moveAnyNotation(const char *m,piece color,variant Vr=REGULAR);
  void moveStdNotation(const char *m,piece color,variant Vr=REGULAR);
