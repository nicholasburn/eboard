/* $Id: chess.h,v 1.49 2010/06/30 14:23:54 bergo Exp $ */
...
class PGNpair {
 public:
  PGNpair();
  PGNpair(const char *n, const char *v);
...
class PGNheader {
 public:
  ...
  void setIfAbsent(const char *n,const char *v);
...
class ChessGame : public MoveListListener {
 public:
  ...
  void endGame(const char *reason,GameResult _result);
